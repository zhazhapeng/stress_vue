  ...
  <section id="main" class="d-flex justify-cntent-center align-items-center">
    <div class="container" id="search">
      ...
      <div class="card">
        ...
        <div class="text-des">Here, we provide an advanced search content for users, and you can combine two or more keywords to perform a more accurate search. For example: gene + condition ("WRKY" AND "quad/WT"), etc.</div>
        <div class="card-body">
          <!-- Advanced search -->
          <form id="advance_search_form" action="result.php" method="post" onSubmit="return check_advance_search_form()">
            ...
            <div class="row">
              <div class="col-md-1"></div>
              <div class="col-md-2">
                <select class="form-control my-select-tag" name="simple_search_link2" id="simple_search_link2">
                  <option value="and">AND</option>
                  <option value="or">OR</option>
                  <option value="and not">NOT</option>
                </select>
              ...
              <div class="col-md-2">
                <select class="form-control my-select-tag" id="simple_search_tag2" name="simple_search_tag2">
                  <option value="Context">Any Field</option>
                  <option value="proid uniprotaccs">Protein Accession</option>
                  <option value="genename">Gene Name</option>
                  <option value="proteinname">Protein Name</option>
              ...
              <div class="col-md-6">
                <input class="form-control" type="text" placeholder="Please select a type and enter keyword(s)." id="simple_search_input2" name="simple_search_input2">
              </div>
              <div class="col-md-1">
                <i class="ri-add-circle-fill"></i><i class="ri-indeterminate-circle-fill"></i>
              </div>
            </div>
      ...
      <div class="card">
        ...
        <div class="text-des">Here, we provide an blast search content for users, and you can input a protein sequence and search the result.</div>
        <div class="card-body">
          <!-- Blast search -->
          <form id="blast_search_form" action="blast.php" method="post" onSubmit="return check_blast_search_form()">
            ...
            <div class="row row1">
              <div class="col-md-3"></div>
              <div class="col-md-2">
                <button type="button" class="form-control btn btn-mine" id="Example2">Example</button>
              </div>
              <div class="col-md-2">
                <button type="reset" class="form-control btn btn-mine">Clear</button>
              </div>
